...
/* harmony import */ var _components_scrolling__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/scrolling */ "./src/scripts/components/scrolling.js");
/* harmony import */ var _components_titles__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/titles */ "./src/scripts/components/titles.js");
/** =======================================================================
...
Object(_components_prism__WEBPACK_IMPORTED_MODULE_6__["default"])();
Object(_components_projects__WEBPACK_IMPORTED_MODULE_7__["default"])();
Object(_components_scrolling__WEBPACK_IMPORTED_MODULE_8__["default"])();
Object(_components_titles__WEBPACK_IMPORTED_MODULE_9__["default"])();
...
function dribbble() {
  ...
  var numberOfShots = 6; // Call Dribbble v2 API
    ...
    success: function success(data) {
      if (0 < data.length) {
        $.each(data, function (i, val) {
          var title = val.title || '';
          var htmlUrl = val.html_url || 'https://dribbble.com/onemohrtime';
          var teaserUrl = val.images.teaser || null;
          var normalUrl = val.images.normal || null;
          var hidpiUrl = val.images.hidpi || null; // strip tags off to avoid front-end code breaking

          var description = val.description.replace(/(<([^>]+)>)/gi, '') || val.title; // manually truncate description

          var trimmedDesc = jQuery.trim(description).substring(0, 80).trim(this) + '...';
          $('#dribbbles').append("\n            <figure id=\"shot_".concat(val.id, "\" class=\"shot\">\n              <a class=\"shot__link\" href=\"").concat(hidpiUrl, "\" data-fancybox=\"dribbble\" data-caption=\"").concat(trimmedDesc, "\" title=\"See ").concat(title, " on Dribbble\" aria-describedby=\"caption-").concat(i, "\"></a>\n              <img src=\"").concat(teaserUrl, "\" alt=\"").concat(title, "\" srcset=\"").concat(normalUrl, " 800w, ").concat(hidpiUrl, " 1600w\" class=\"shot__image\" />\n              <figcaption class=\"shot--hover\" id=\"caption-").concat(i, "\">\n                <h3 class=\"shot__headline _headline -underline\">").concat(title, "</h3>\n                <span class=\"shot__description\">").concat(trimmedDesc, "</span>\n              </figcaption>\n            </figure>\n            ")); // limit to 6 shots
...
function gallery() {
  ...
  gallery.forEach(function (media) {
    // Fade images in
    media.classList.add('get-faded'); // Leverage imagesLoaded to delay Isotope
  ...
  if ($projGallery && $projGallery.length) {
    $projGallery.each(function (index, item) {
      ...
      var projGalleryIso = new isotope_layout__WEBPACK_IMPORTED_MODULE_0___default.a(item, {
        itemSelector: '.js-image',
        percentPosition: true,
        masonry: {
  ...
  if ($wpGallery && $wpGallery.length) {
    $wpGallery.each(function (index, item) {
      ...
      var wpGalleryIso = new isotope_layout__WEBPACK_IMPORTED_MODULE_0___default.a(item, {
...
function parallax() {
  ...
  var $parallax = $('.-parallax'); // $parallax.each( function(i,e) {
  // console.log(i);
  // console.log(e);
...
function projects() {
   ...
   */
  var designGallery = document.querySelector('#gallery'); // If there is a gallery

  if (designGallery) {
    // stack articles vertically
    var designGalleryIso = new isotope_layout__WEBPACK_IMPORTED_MODULE_0___default.a(designGallery, {
    ...
    $getFaded.each(function (i, e) {
      ...
      var getFadedIn = gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].timeline({
        scrollTrigger: {
          ...
          toggleActions: 'play none none none',
          onEnter: function onEnter() {
            return $(_this).removeClass('get-faded').addClass('got-faded');
          },
          onEnterBack: function onEnterBack() {
            return $(_this).removeClass('get-faded').addClass('got-faded');
          }
