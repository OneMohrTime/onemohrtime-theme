...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_dribbble__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/dribbble */ "./src/scripts/components/dribbble.js");
/* harmony import */ var _components_gallery__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/gallery */ "./src/scripts/components/gallery.js");
/* harmony import */ var _components_homepage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/homepage */ "./src/scripts/components/homepage.js");
/* harmony import */ var _components_images__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/images */ "./src/scripts/components/images.js");
/* harmony import */ var _components_navigation__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/navigation */ "./src/scripts/components/navigation.js");
/* harmony import */ var _components_parallax__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/parallax */ "./src/scripts/components/parallax.js");
/* harmony import */ var _components_prism__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/prism */ "./src/scripts/components/prism.js");
/* harmony import */ var _components_scrolling__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/scrolling */ "./src/scripts/components/scrolling.js");
/* harmony import */ var _components_titles__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/titles */ "./src/scripts/components/titles.js");
/** =======================================================================
...
Object(_components_dribbble__WEBPACK_IMPORTED_MODULE_0__["default"])();
Object(_components_gallery__WEBPACK_IMPORTED_MODULE_1__["default"])();
Object(_components_homepage__WEBPACK_IMPORTED_MODULE_2__["default"])();
Object(_components_images__WEBPACK_IMPORTED_MODULE_3__["default"])();
Object(_components_navigation__WEBPACK_IMPORTED_MODULE_4__["default"])();
Object(_components_parallax__WEBPACK_IMPORTED_MODULE_5__["default"])();
Object(_components_prism__WEBPACK_IMPORTED_MODULE_6__["default"])(); // projects();

Object(_components_scrolling__WEBPACK_IMPORTED_MODULE_7__["default"])();
Object(_components_titles__WEBPACK_IMPORTED_MODULE_8__["default"])();

/***/ }),

/***/ "./src/scripts/components/dribbble.js":
/*!********************************************!*\
  !*** ./src/scripts/components/dribbble.js ***!
  \********************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return dribbble; });
/** =======================================================================
 * Components / Dribbble
 * ===================================================================== */
function dribbble() {
  ...
  var dribbbles = document.querySelector('#dribbbles');
  ...
  var numberOfShots = 6;
  var todaysDate = new Date().toISOString(); // Call Dribbble v2 API
    ...
    success: function success(data) {
      if (0 < data.length) {
        for (var i = 0; i < numberOfShots; i++) {
          ...
          var htmlUrl = data[i].html_url || 'https://dribbble.com/onemohrtime';
          var teaserUrl = data[i].images.teaser || null;
          var normalUrl = data[i].images.normal || null;
          var hidpiUrl = data[i].images.hidpi || null; // strip tags off to avoid front-end code breaking

          var description = data[i].description.replace(/(<([^>]+)>)/gi, '') || data[i].title; // manually truncate description

          var trimmedDesc = jQuery.trim(description).substring(0, 80).trim(this) + '...'; // $('#dribbbles').append('<li class="dribbble-list__item grid-col"><a href="' + shotUrl + '"><article class="dribbble"><header class="dribbble__detail"><h1 class="dribbble__title">' + shotTitle + '</h1></header><img class="dribbble__thumb" src="' + shotImg + '" width="320" height="240" alt="' + shotTitle + '" /></article></a></li>');

          $('#dribbbles').append("\n            <figure id=\"shot_".concat(data[i].id, "\" class=\"shot\">\n              <a class=\"shot__link\" href=\"").concat(hidpiUrl, "\" data-fancybox=\"dribbble\" data-caption=\"").concat(trimmedDesc, "\" title=\"See ").concat(title, " on Dribbble\" aria-describedby=\"caption-").concat(i, "\">Click to see ").concat(title, " on Dribbble</a>\n              <img src=\"").concat(teaserUrl, "\" alt=\"").concat(title, "\" srcset=\"").concat(normalUrl, " 800w, ").concat(hidpiUrl, " 1600w\" class=\"shot__image\" />\n              <figcaption class=\"shot--hover\" id=\"caption-").concat(i, "\">\n                <h3 class=\"shot__headline _headline -underline\">").concat(title, "</h3>\n                <div class=\"shot__description\">\n                  <span>").concat(trimmedDesc, "</span>\n                  <div class=\"shot__button\">\n                    <a href=\"").concat(htmlUrl, "\" target=\"_blank\">See on Dribbble</a>\n                  </div>\n                </div>\n              </figcaption>\n            </figure>\n          "));
        }
      } else {
...
function gallery() {
  ...
  var gallery = document.querySelectorAll('._gallery'); // Do nothing if we find none
  ...
  gallery.forEach(function (media) {
    ...
    imagesloaded__WEBPACK_IMPORTED_MODULE_1___default()(media, function () {
      // init Isotope after all images have loaded
      var iso = new isotope_layout__WEBPACK_IMPORTED_MODULE_0___default.a(media, {
...
function homepage() {
  var homePage = document.querySelector('body.home'); // make sure this is actually the home page
  ...
  var homeTitle = document.querySelector('#home_title');
  var homeTitleRow = homeTitle.querySelectorAll('.-row');
  homeTitleRow.forEach(function (row) {
    // Wrap each word in the row with a `span`
    row.innerHTML = row.innerHTML.replace(/(^|<\/?[^>]+>|\s+)([^\s<]+)/g, '$1<span class="-word">$2</span>');
  });
  var homeTitleWords = homeTitle.querySelectorAll('.-word');
  homeTitleWords.forEach(function (word) {
    // Create animating div + span for later
    var wordBlock = document.createElement('div'); // Wrap existing text first

    word.innerHTML = "<span class=\"-text\">".concat(word.innerHTML, "</span>"); // Add block to spans second
...
/***/ "./src/scripts/components/images.js":
/*!******************************************!*\
  !*** ./src/scripts/components/images.js ***!
  \******************************************/
/*! exports provided: default */
...
function images() {
  ...
  $('[data-fancybox]').fancybox({
    ...
    */
    ...
    wheel: false // // Custom options when mobile device is detected
    // // =============================================
    // mobile: {
...
function navigation() {
  ...
  var viewportHeight = window.innerHeight; // console.log( 'Current viewport: ' +  viewportWidth + 'w × ' + viewportHeight + 'h' );
  ...
  var $navbar = $('#masthead');
  var $mobileMenu = $('#desktop_menu');
  var $desktopMenu = $('#primary_nav');
  var $menuItems = $('#desktop_menu').children();
  var menuDuration = 0.15;
  var menuBetween = 0.05;
  var mobileTimeline = new gsap__WEBPACK_IMPORTED_MODULE_0__["TimelineMax"]({
    paused: true,
    delay: 1
  });
  var desktopTimeline = new gsap__WEBPACK_IMPORTED_MODULE_0__["TimelineMax"]();
  ...
  var mobileTrigger = viewportWidth < 601 ? true : false;
  ...
  $('a[href^="#contact"]').on('click', function (e) {
    ...
    $('#contact').addClass('said-hi'); // $( 'html, body' ).animate({ scrollTop: 0 }, 'fast');
    // remove visible classes from navbar

    $('#mobile_menu').removeClass('is-visible'); // remove mobile GSAP classes
...
function parallax() {
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].registerPlugin(gsap_scrollTrigger__WEBPACK_IMPORTED_MODULE_2__["default"]); // Viewport check
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].utils.toArray($parallax).forEach(function (parallax) {
    // Leverage scrolltrigger
    // https://greensock.com/docs/v3/Plugins/ScrollTrigger/
    gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].to(parallax, {
      scrollTrigger: {
        // markers: true,
        trigger: parallax,
        ...
        onEnter: function onEnter() {
          return $(_this).addClass('-scrolling');
        },
        onLeave: function onLeave() {
          return $(_this).removeClass('-scrolling');
        },
...
/***/ "./src/scripts/components/prism.js":
/*!*****************************************!*\
  !*** ./src/scripts/components/prism.js ***!
  \*****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(module, global) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return prism; });
/** =======================================================================
 * Components / PrismJS 1.22.0
 *
...
/***/ "./src/scripts/components/scrolling.js":
/*!*********************************************!*\
  !*** ./src/scripts/components/scrolling.js ***!
  \*********************************************/
/*! exports provided: default */
...
function scrolling() {
  ...
  if ($getFaded.length > 1) {
    ...
    $getFaded.each(function (i, e) {
      ...
      var $this = $(this);
      var fadeContainer = e; // let $fadeChildren = $(this).find('> *');

      var $fadeChildren = $(this).children();
      var fadeDuration = 1.25;
      var fadeBetween = 0.0625;
      var getFadedIn = gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].timeline({
        scrollTrigger: {
          ...
          toggleActions: 'play none none none',
          onEnter: function onEnter() {
            return $(_this).removeClass('-getFaded').addClass('-gotFaded');
          },
          onEnterBack: function onEnterBack() {
            return $(_this).removeClass('-getFaded').addClass('-gotFaded');
          }
  ...
  var isHomePage = document.querySelector('body.home') ? true : false; // If it is..

  if (isHomePage) {
    // Animate dribbble headline in
    var homeTimeline = gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].timeline({
      start: 'top 80%',
      // markers: 'true',
      toggleActions: 'play none none none'
    }); // console.log(homeTimeline);

    var dribbbleTitle = $('.dribbble__title');
...
/***/ "./src/scripts/components/titles.js":
/*!******************************************!*\
  !*** ./src/scripts/components/titles.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return titles; });
/** =======================================================================
 * Components / Titles
 * ===================================================================== */
function titles() {
  var animTitle = document.querySelector('.title--animated'); // make sure this is actually the home page
  ...
  animTitle.innerHTML = animTitle.innerHTML.replace(/(^|<\/?[^>]+>|\s+)([^\s<]+)/g, '$1<span class="-word">$2</span>'); // console.log(animTitle);

  var animTitleWords = animTitle.querySelectorAll('.-word');
  animTitleWords.forEach(function (word) {
    // Create animating div + span for later
    var wordBlock = document.createElement('div'); // Wrap existing text first
...
__webpack_require__(/*! /Users/fatmac/Sites/onemohrtime/wp-content/themes/onemohrtime/src/scripts/app.js */"./src/scripts/app.js");
module.exports = __webpack_require__(/*! /Users/fatmac/Sites/onemohrtime/wp-content/themes/onemohrtime/src/styles/app.scss */"./src/styles/app.scss");
