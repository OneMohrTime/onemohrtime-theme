...
/* harmony import */ var _components_projects__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/projects */ "./src/scripts/components/projects.js");
...
Object(_components_projects__WEBPACK_IMPORTED_MODULE_5__["default"])();
...
function gallery() {
  ...
  if ($gallery && $gallery.length) {
    $gallery.each(function (index, item) {
      ...
      var galleryIso = new isotope_layout__WEBPACK_IMPORTED_MODULE_0___default.a(item, {
...
function projects() {
   ...
   */
  var $designGallery = $('#gallery'); // if ( $designGallery.length ) {
