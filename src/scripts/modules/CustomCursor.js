...
export default class extends es6Module {
  ...
  init() {
    const cursor = new CustomCursor('.cursor', {
      ...
      focusElements: [
        {
          elements: 'a, button, input[type="submit"], input[type="button"], select, select:read-only .c-button, .f-button, .wpforms-icon-choices-item, .flatpickr-input[readonly], .calendly-badge-widget .calendly-badge-content',
