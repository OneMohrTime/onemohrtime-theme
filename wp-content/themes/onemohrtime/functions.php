...
function onemohrtime_head_cleanup() {
	// category feeds
	...
	add_filter( 'style_loader_src', 'onemohrtime_remove_wp_ver_css_js', 9999 );
	// remove Wp version from scripts
	add_filter( 'script_loader_src', 'onemohrtime_remove_wp_ver_css_js', 9999 );
}
