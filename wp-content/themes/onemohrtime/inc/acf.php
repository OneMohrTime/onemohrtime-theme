...
acf_add_local_field_group(array (
	'key' => 'group_583243bb67308',
	'title' => 'Blog Posts',
	'fields' => array (
		array (
			'key' => 'field_57784abb5ddce',
			'label' => 'Sticky Image',
			'name' => 'sticky_image',
			'type' => 'image',
			'instructions' => 'Image to affix to side of the post',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array (
				'width' => '',
		...
		array (
			...
			'sub_fields' => array (
				...
				array (
					...
					'max_height' => '',
					'max_size' => '',
					'mime_types' => 'gif, png, jpg, jpeg, svg',
				),
				array (
					'key' => 'field_583245922d7fa',
					'label' => 'Text',
					'name' => 'service_body',
					'type' => 'wysiwyg',
					'instructions' => '',
				...
				array (
					'key' => 'field_58324ebb7609c',
					'label' => 'Link',
					'name' => 'service_link',
					'type' => 'text',
					'instructions' => 'URL of linked page',
					'required' => 0,
					'conditional_logic' => 0,
					'wrapper' => array (
						'width' => '',
	...
	'fields' => array (
		array (
			...
			'sub_fields' => array (
				...
				array (
					'key' => 'field_583e4ee7b89e1',
					'label' => 'Website URL',
					'name' => 'proj_link_url',
					'type' => 'url',
					'instructions' => '(No http:// needed)',
					'required' => 0,
					'conditional_logic' => array (
						array (
							array (
								'field' => 'field_583e4fba55f06',
								'operator' => '==',
								'value' => 'website',
							),
						),
				...
				array (
					'key' => 'field_583e531942eaa',
					'label' => 'Article URL',
					'name' => 'proj_type_article',
					'type' => 'url',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => array (
