            ...
            <section class="homepage__slideshow swiper-container">
                <div class="swiper-wrapper">
                    ...
                    <figure class="slide swiper-slide">
                        ...
                        <img src="<?php echo $slideImg['sizes']['thumbnail'] ?>" alt="<?php echo $slideImg['alt'] ?>" class="slide__img" srcset="<?php echo $slideImg['sizes']['medium'] ?> 1024w, <?php echo $slideImg['sizes']['large'] ?> 1440w, <?php echo $slideImg['url'] ?> 1920w" />
                        <?php endif; ?>
