...
function assets() {
	...
	wp_enqueue_script('sage/main.js', Assets\asset_path('scripts/main.js'), ['jquery'], null, true);
	wp_enqueue_script('sage/mixitup.js', Assets\asset_path('scripts/mixitup.js'), ['jquery'], null, true);
}
