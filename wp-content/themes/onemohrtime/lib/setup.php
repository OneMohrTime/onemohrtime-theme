...
function setup() {
  ...
  register_nav_menus([
    ...
    'footer_projects'    => __('Footer Projects', 'onemohrtime')
  ]);
...
//	wp_add_inline_script ('jquery', 'if (!window.jQuery) { document.write(\'<script src="' + get_template_directory_uri() + '/js/jquery-3.2.1.min.js"><\/script>\'); }');
	...
	wp_enqueue_style('google-fonts', '//fonts.googleapis.com/css?family=Barlow+Semi+Condensed:700|Barlow:400,400i,700', array('onemohrtime-stylesheet'), null, 'all' );
